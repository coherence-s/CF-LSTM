...
if __name__ == '__main__':
	...
	path_to_dataset = './checkpoints/'+maneuver_type+'_zhouxq/{0}'.format(fold)
	path_to_checkpoints = './checkpoints/'+maneuver_type+'_zhouxq/{0}'.format(fold)
	...
	epochs = 600
	batch_size = num_train   #num_train
