...
if maneuver_type == 'all':
	index = '356988'
elif maneuver_type == 'all_zhouxq':
	index = '356988'
elif maneuver_type == 'lane':
	index = '723759'
elif maneuver_type == 'lane_zhouxq':
	index = '723759'
elif maneuver_type == 'turns':
	index = '209221'
elif maneuver_type == 'turns_zhouxq':
	index = '209221'
elif maneuver_type == 'all_new_features' or maneuver_type=='lane_new_features' or maneuver_type=='turn_new_features':
	index = '846483'
elif maneuver_type == 'all_new_features_zhouxq' or maneuver_type=='lane_new_features_zhouxq' or maneuver_type=='turn_new_features_zhouxq':
...
checkpoint_dir = './checkpoints/'+ maneuver_type
